    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="text-center space-y-3 md:space-y-4 px-4">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-3">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold">RestaurantChain Documentation</h1>
        </div>
      ...
      <Card>
        <CardHeader className="p-4 md:p-6">
          ...
          <CardDescription className="text-xs md:text-sm">Get started with RestaurantChain in 3 simple steps</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3 md:space-y-4 p-4 md:p-6">
          <div className="grid gap-3 md:gap-4 md:grid-cols-3">
            <div className="flex items-start gap-2 md:gap-3 p-3 md:p-4 rounded-lg border">
              <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-xs md:text-sm flex-shrink-0">1</div>
              <div>
                <h3 className="font-semibold text-sm md:text-base">Connect Wallet</h3>
                <p className="text-xs md:text-sm text-muted-foreground">Click the wallet button in the top right to connect your Solana wallet</p>
              </div>
            </div>
            <div className="flex items-start gap-2 md:gap-3 p-3 md:p-4 rounded-lg border">
              <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-xs md:text-sm flex-shrink-0">2</div>
              <div>
                <h3 className="font-semibold text-sm md:text-base">Register Restaurant</h3>
                <p className="text-xs md:text-sm text-muted-foreground">Add your restaurant to the blockchain with name and description</p>
              </div>
            </div>
            <div className="flex items-start gap-2 md:gap-3 p-3 md:p-4 rounded-lg border">
              <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-xs md:text-sm flex-shrink-0">3</div>
              <div>
                <h3 className="font-semibold text-sm md:text-base">Start Reviewing</h3>
                <p className="text-xs md:text-sm text-muted-foreground">Browse restaurants and add reviews to help the community</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      {categories.map((category) => (
        <Card key={category}>
          <CardHeader className="p-4 md:p-6">
            ...
            <CardDescription className="text-xs md:text-sm">Explore the features that make RestaurantChain unique</CardDescription>
          </CardHeader>
          <CardContent className="p-4 md:p-6">
            <div className="grid gap-3 md:gap-4 md:grid-cols-2">
              {features
                ...
                .map((feature) => (
                  <div key={feature.title} className="flex items-start gap-2 md:gap-3 p-3 md:p-4 rounded-lg border hover:bg-accent/5 transition-colors">
                    <div className="text-primary mt-0.5 md:mt-1 flex-shrink-0">{feature.icon}</div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <div className="bg-gray-900 text-gray-100 rounded-lg p-3 md:p-4 overflow-x-auto">
                <div className="flex items-center justify-between mb-2 md:mb-3">
                  ...
                  <span className="text-[10px] md:text-xs text-gray-400">restaurant_reviews.rs</span>
                </div>
    ...
    MathOverflow,
      ...
      <Card>
        <CardHeader className="p-4 md:p-6">
          ...
          <CardDescription className="text-xs md:text-sm">Built with modern web technologies and blockchain innovation</CardDescription>
        </CardHeader>
        <CardContent className="p-4 md:p-6">
          <div className="grid gap-2 md:gap-3 md:grid-cols-2 lg:grid-cols-4">
            {techStack.map((tech) => (
              <div key={tech.name} className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2 p-2 md:p-3 rounded-lg border">
                <Badge variant="secondary" className="text-xs">{tech.name}</Badge>
                <span className="text-xs md:text-sm text-muted-foreground">{tech.description}</span>
              </div>
            ))}
          </div>
        </CardContent>
